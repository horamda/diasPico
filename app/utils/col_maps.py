...
ARTICULOS_MAP: dict[str, list[str]] = {
    ...
    'pisos': ['pisos', 'capas', 'camadas', 'cantidad pisos', 'cant pisos', 'pisos pallet', 'capas pallet', 'camadas pallet'],
    'apilabilidad': ['apilabilidad', 'apilable'],
    'bultos_por_piso': ['bultos por piso', 'bultos_por_piso', 'bultos x piso', 'bultos por capa', 'bultos x capa', 'bultos por camada', 'bultos x camada', 'bultos/piso', 'bultos/capa', 'blt piso', 'blt capa'],
