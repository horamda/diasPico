...
ARTICULOS_MAP: dict[str, list[str]] = {
    ...
    'activo': ['activo'],
    'bultos_por_pallet': ['bultos por pallet', 'bultos_por_pallet', 'bultos x pallet', 'bultos pallet', 'bultos/pallet', 'blt pallet'],
    'pisos': ['pisos por pallet', 'pisos por palet', 'cantidad de pisos', 'cant pisos pallet', 'capas por pallet', 'camadas por pallet', 'pisos', 'capas', 'camadas', 'cantidad pisos', 'cant pisos', 'pisos pallet', 'capas pallet', 'camadas pallet'],
    'apilabilidad': ['apilabilidad', 'apilable'],
    'bultos_por_piso': ['cantidad bultos por piso', 'cant bultos por piso', 'bultos por nivel', 'bultos x nivel', 'bultos por piso', 'bultos_por_piso', 'bultos x piso', 'bultos por capa', 'bultos x capa', 'bultos por camada', 'bultos x camada', 'bultos/piso', 'bultos/capa', 'blt piso', 'blt capa'],
